...
class AutoBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False, embed=None, diversity = False):
        """
        ...
        if self.pt or self.nn_module:
            y = self.model(im, augment=augment, visualize=visualize, embed=embed, diversity = diversity)
