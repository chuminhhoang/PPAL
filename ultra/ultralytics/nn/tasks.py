...
class BaseModel(nn.Module):
    ...
    def predict(self, x, profile=False, visualize=False, augment=False, embed=None, diversity=None):
        """
        ...
        if diversity:
            return self._predict_diversity(x, profile, visualize, embed)
        else:
            return self._predict_once(x, profile, visualize, embed)

    def _predict_diversity(self, x, profile=False, visualize=False, embed=None):
        """
        Perform a forward pass through the network.
